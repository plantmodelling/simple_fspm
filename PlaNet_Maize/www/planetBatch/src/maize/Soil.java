...
public class Soil{
	 ...
	 * @return temperature [°C]
	 */
	public static double getTemperature(int time, Point3d position) {
	 ...
	 */		
	public static double getLight(Point3d position) {
	
		double light;
		int time = Time.getCurrentHour();  
			
		if (time > 5 && time < 20) light = (-7 * time * time)+(184 * time) - 707;
		else light = 0;
